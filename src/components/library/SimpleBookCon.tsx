 ...
 */
export default function SimpleBookContent({
  contentProps,
}: {
  contentProps: {
  ...
  return (
    <section>
      <Title level={contentProps.level} id={contentProps.title.replaceAll(" ", "-").toLowerCase()}>
        {contentProps.title}
    </Title>
      ...
      <div className="text-justify">{contentProps.text && textData}</div>
    </section>
  );
}
