        ...
        <SimpleContent
          contentProps={{
            ...
            text: [
              ...
              "Amidst the turmoil, the last incomprehensible Pioneer artifact, which had long stood atop Teothe's desert, vanished into nothingness, leading the magic-affiliated mourn the loss of the opportunity to grasp the past's inherited knowledge.",
