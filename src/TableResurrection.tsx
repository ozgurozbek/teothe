...
export default function ResurrectionTable() {
  ...
  return (<section className="py-4">
    <SimpleContent
      contentProps={{
        title: "Resurrection",
        text: ["RAW resurrection spells such as 'Revivify' are not allowed besides this table. There are penalties for consecutive resurrections, ask DM. Materials are consumed by the spell. Keep in mind you'll need a body, or a part of it in most cases."]
      }}
    />
