...
export default function LibraryPage() {
  return (
    <>
      <Metadata
        title="Teothe - A 5E Campaign Setting | Library"
        description="Access a vast repository of knowledge in our Library, featuring fiction, historical events and more."
      />
      <section>
