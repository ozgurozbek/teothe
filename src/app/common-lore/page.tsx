...
export default function CommonLorePage() {
  return (
    <>
      <Metadata
        title="Teothe - A 5E Campaign Setting | Common Lore"
        description="Dive into the extensive lore of Teothe, including history, cultures and cosmology, in our Common Lore section."
      />
      <section>
