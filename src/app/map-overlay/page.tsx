...
export default function MapOverlayPage() {
  ...
  return (
    <>
      <Metadata
        title="Teothe - A 5E Campaign Setting | Map Overlay"
        description="Explore routes and unlock the mysteries of Teothe by overlaying different maps, revealing alternate maps and travel guides."
      />
      <section>
