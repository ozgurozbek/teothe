...
export default function DeitiesPage() {
  return (
    <>
      <Metadata
        title="Teothe - A 5E Campaign Setting | Deities"
        description="Explore the pantheon of gods and goddesses that shape the destiny of Teothe, with domains, hierarchy, and legendary tales awaiting discovery."
      />
      <section>
